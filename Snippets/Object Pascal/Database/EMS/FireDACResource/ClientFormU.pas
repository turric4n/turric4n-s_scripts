...
type
  TClientForm = class(TForm)
    ...
    procedure ActionUndoPostExecute(Sender: TObject);
  private
...
procedure TClientForm.ActionUndoPostExecute(Sender: TObject);
begin
  EMSFireDACClient1.SchemaAdapter.CancelUpdates;
end;
