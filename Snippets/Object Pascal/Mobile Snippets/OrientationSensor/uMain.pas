...
begin
  ...
  OrientationSensor1.Active := swOrientationSensorActive.IsChecked;
  if OrientationSensor1.Active then
    Timer1.Enabled := OrientationSensor1.Active;
  if not OrientationSensor1.Active and swOrientationSensorActive.IsChecked then
    lbOrientationSensor.Text := 'Suitable sensors not found';
end;
